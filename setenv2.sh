...
CATALINA_OPTS="$CATALINA_OPTS -Djgroups.bind_addr=node2liferaydxp"
CATALINA_OPTS="$CATALINA_OPTS -Djgroups.tcpping.initial_hosts=node2liferaydxp[7800],node1liferaydxp[7800]"
